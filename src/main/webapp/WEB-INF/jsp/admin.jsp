...
<body>
	...
	<div class="container">
		<div class="col-sm-offset-4 col-sm-4 ">
			...
			<div class="well">
				...
				<form method="get" action="admin_moderate.html">
					<button class="btn btn-primary btn-block" type="submit" value="Submit">Moderate</button>
				</form>
				<br> <br>
			</div>
		</div>
		...
		<form method="get" action="admin_init.html">
			<button class="btn btn-default btn-block" type="submit" value="Submit">Debug init.</button>
		</form>
	</div>
